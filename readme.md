...
- [React Native using EXPO](https://docs.expo.dev/router/installation/#manual-installation)
...
📖 [JSMastery AORA GitHub](https://github.com/adrianhajdin/aora)

<!-- Below is copied from JSMastery AORA GiHub Readme -->
<details>
<summary>Reference for this Project by JSMastery</summary>

# Learning React Native Crash Course
